...
# Tokyonight
betterlockscreen -u $USER_HOME/.wallpapers/tokyo-night-space.png --display 1
betterlockscreen -u $USER_HOME/.wallpapers/tokyo-night-space.png --blur 0.5 --display 1
